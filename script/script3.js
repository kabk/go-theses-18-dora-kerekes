        ...
        setInterval(function(){ 
            ...
            for (var y = 0; y < rows; y++) {
                ...
                ctx.drawImage(
                    ...
                    x * pieceWidth, y * pieceHeight, pieceWidth/10.0, pieceHeight-10.0,
                    // draw it on canvas based on the shuffled pieces[] array
                    p.col +x * pieceWidth, p.row * pieceHeight+x*0.01, pieceWidth, pieceHeight
                );
                }
            }
            ...
            rows = 10+Math.abs(Math.cos(frame*0.001)*120.0);
            cols = 10+Math.abs(Math.sin(frame*0.001)*120.0);
            // if(rows > 11) {
            //     rows = 0;
            //     cols = 0;
            // }
