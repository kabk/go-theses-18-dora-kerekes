        ...
        setInterval(function(){ 
            ...
            for (var y = 0; y < rows; y++) {
                ...
                ctx.drawImage(
                    ...
                    x * pieceWidth, y * pieceHeight, pieceWidth+20.0, pieceHeight,
                    // draw it on canvas based on the shuffled pieces[] array
                    p.col +x * pieceWidth, p.row * pieceHeight, pieceWidth, pieceHeight
                );
                }
            }
            ...
            rows = Math.abs(Math.cos(frame*0.01)*100.0);
            cols = Math.abs(Math.sin(frame*0.01)*100.0);
            // if(rows > 11) {
            //     rows = 0;
            //     cols = 0;
            // }
